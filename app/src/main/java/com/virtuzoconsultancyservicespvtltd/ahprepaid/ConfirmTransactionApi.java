...
public class ConfirmTransactionApi {
    ...
    public ConfirmTransactionApi(String Response, String TxnID, int StatusID,
                                 String PaymentId, String loginID, String DistributorID, String ChargedAmount) {
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            url = URL.Server + "/UpdateTopupPayment"
                    + "?Response=" + Response
                    + "&TxnID=" + TxnId
                    + "&StatusID=" + StatusID
                    + "&PaymentId=" + PaymentId
