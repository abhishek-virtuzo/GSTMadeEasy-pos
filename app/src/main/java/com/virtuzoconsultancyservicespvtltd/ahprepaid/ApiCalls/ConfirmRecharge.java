...
public class ConfirmRecharge {
    ...
    public ConfirmRecharge(String paymnetId, OperatorClass operator, PlanClass plan, String mobileno, String zipcode,
                           String paypalPaymentId, int rechargeVia, String distributorId, String loginId) {
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                int responseCodeInt = response.getInt("Responsecode");

                if (responseCodeInt == 0) {
