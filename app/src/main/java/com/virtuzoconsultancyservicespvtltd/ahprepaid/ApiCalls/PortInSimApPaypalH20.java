 ...
 */
public class PortInSimApPaypalH20 {
    ...
    public PortInSimApPaypalH20(Context context, String plan, String amount, String email, String operator, String zipcode, String simcardno,
                                ...
                                String city, String serviceProvider, String state, String customerName, String Address, String paymentid) {
    ...
    public class ApiCall extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = URL.Server + "/PortInSIMForH2OWithPaypal?" +
            ...
            //       http://virtuzo.in/AHPrepaidMultipleNetworkService/AhprepaidAPI_Json.svc/PortInSIMForH2OWithPaypal?
            // ClientTypeID=2&DistributorID=3173&TariffID=11&SimNumber=8919601000152044679&TariffAmount=10&
            // LoginID=30196&EmailID=shadab.a@virtuzo.in&ZipCode=95222&City=Newyark&PhoneToPort=8756565656
            // &PIN=23232323&ServiceProvider=63443&State=California&CustomerName=HARJEET singh&Address=New Yark&PaymentId=194651
