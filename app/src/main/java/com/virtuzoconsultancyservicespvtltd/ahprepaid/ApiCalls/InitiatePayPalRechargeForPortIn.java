...
public class InitiatePayPalRechargeForPortIn {
    ...
    public InitiatePayPalRechargeForPortIn(String loginID, String distributorID, Float amount, String TariffId) {
    ...
    public class InitiatePayPalRechargeApiCall extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = URL.Server + "/initiatePaymentPaypalPortInForLycaMobile?" +
                    "loginID=" + loginID +
