 ...
 */
public class PortInSIMForLycaMobileWithPaypal {
    ...
    String iswallet;
    String month;
    String plan, amount, email, operator, zipcode, simcardno, PhoneToPort;
    String balance;
    Context context;
    String PhonePort, Pin, AccountNo, PaymentID;

    public PortInSIMForLycaMobileWithPaypal(Context context, String plan, String amount, String email, String operator, String zipcode, String simcardno,
                                            String clientid, String loginid, String distributorid, String iswallet, String PhonePort, String tariffid, String accountNo, String Pin, String PaymentID) {
    ...
    public class ApiCall extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = URL.Server + "/PortInSimForLycaMobile?" +
                    ...
                    "&EmailID=" + email +
                    "&ZipCode=" + zipcode +
                    "&PhoneToPort=" + PhoneToPort +
                    "&AccountNumber=" + AccountNo +
                    "&PIN=" + Pin +
                    "PaymentID=" + PaymentID +
                    "&IsWalet=" + iswallet +
                    "&TariffPlan=" + plan;
//PortInSIMForLycaMobileWithPaypal?ClientTypeID={ClientTypeID}&DistributorID={DistributorID}&TariffID={TariffID}&SimNumber={SimNumber}&
// TariffAmount={TariffAmount}&LoginID={LoginID}&EmailID={EmailID}&ZipCode={ZipCode}
// &PhoneToPort={PhoneToPort}&AccountNumber={AccountNumber}&PIN={PIN}&PaymentID={PaymentID}&TariffPlan={TariffPlan}"
        ...
        protected void onPostExecute(Void result) {
            ...
            PortConfirmActivity.progressDialog2.dismiss();
        }
