...
public class InitiateWalletRecharge {
    ...
    public InitiateWalletRecharge(String loginID, String distributorID, Float amount) {

        this.loginID = loginID;
        this.distributorID = distributorID;
        this.amount = amount;

        new InitiateWalletRecharge.ApiCall().execute();
    }
    ...
    public class ApiCall extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = URL.Server + "/InitiatePaymentWaletRecharge?"
                    + "loginID=" + loginID
        ...
        protected void onPostExecute(Void result) {
            ...
            RechargePaymentActivity.walletProgressDialog.dismiss();
