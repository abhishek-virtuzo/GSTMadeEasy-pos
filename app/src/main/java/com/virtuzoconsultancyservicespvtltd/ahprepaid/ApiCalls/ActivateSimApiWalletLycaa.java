 ...
 */
public class ActivateSimApiWalletLycaa {
    ...
    public ActivateSimApiWalletLycaa(Context context, String plan, String amount, String email, String operator, String zipcode, String simcardno,
