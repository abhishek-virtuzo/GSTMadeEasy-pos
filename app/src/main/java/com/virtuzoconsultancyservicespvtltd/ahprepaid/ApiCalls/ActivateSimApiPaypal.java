...
public class ActivateSimApiPaypal {
    ...
    public ActivateSimApiPaypal(Context context, String plan, String amount, String email, String operator, String zipcode, String simcardno,
