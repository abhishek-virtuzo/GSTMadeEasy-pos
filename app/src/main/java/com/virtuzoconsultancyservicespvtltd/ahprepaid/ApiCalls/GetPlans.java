...
import com.virtuzoconsultancyservicespvtltd.ahprepaid.Views.Activity.SelectPlanActivity;
...
public class GetPlans {
    ...
    public List<PlanClass> plansList;

    String distributorID;
    int networkID;


    public GetPlans(String distributorID, int networkID) {

        this.distributorID = distributorID;
        this.networkID = networkID;

        new GetPlans.apitask().execute();
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = URL.Server + "/GetRechargeDistributorPlan" +
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        plan = gson.fromJson(jsonString, PlanClass.class);
        ...
        protected void onPostExecute(Void result) {
            ...
            SelectPlanActivity.progressDialog.dismiss();
