...
public interface URL {
    ...
    String MainURL = "http://virtuzo.in/AhprepaidService/AhprepaidAPI_Json.svc";
    ...
    String  TOPUPService="http://virtuzo.in/AhprepaidTestService/AhprepaidAPI_Json.svc/TopupService";
