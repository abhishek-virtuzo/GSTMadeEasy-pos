...
public class ProductListInNewDeliveryOrderAdapter extends RecyclerView.Adapter<ProductListInNewDeliveryOrderAdapter.MyViewHolder> {

    private List<Product> ProductList;
    private ProductListInNewDeliveryOrderAdapter.OnClickListener listener;

    public ProductListInNewDeliveryOrderAdapter(ArrayList<Product> stateList, ProductListInNewDeliveryOrderAdapter.OnClickListener onClickListener) {
        this.ProductList = stateList;
        this.listener = onClickListener;
    }

    @Override
    public ProductListInNewDeliveryOrderAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = null;
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_list_new_deliveryorder_recycle_view_row, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ProductListInNewDeliveryOrderAdapter.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            productNameTextView = (TextView) itemView.findViewById(R.id.productNameInNewPurchaseTextView);
            salesPriceTextView = (TextView) itemView.findViewById(R.id.productSalesPriceInNewPurchaseTextView);
