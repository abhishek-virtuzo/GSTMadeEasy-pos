...
public class ProductListInNewPurchaseAdapter extends RecyclerView.Adapter<ProductListInNewPurchaseAdapter.MyViewHolder> {

    private List<Product> ProductList;
    private ProductListInNewPurchaseAdapter.OnClickListener listener;

    public ProductListInNewPurchaseAdapter(ArrayList<Product> stateList, ProductListInNewPurchaseAdapter.OnClickListener onClickListener) {
        this.ProductList = stateList;
        this.listener = onClickListener;
    }

    @Override
    public ProductListInNewPurchaseAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = null;
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_list_new_purchase_recycle_view_row, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ProductListInNewPurchaseAdapter.MyViewHolder holder, final int position) {
