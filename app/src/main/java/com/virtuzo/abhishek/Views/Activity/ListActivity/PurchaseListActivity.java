...
public class PurchaseListActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        purchaseListAdapter = new PurchaseListAdapter(listOfPurchases, new PurchaseListAdapter.OnClickListener() {
            ...
            public void onItemClick(MasterPurchase masterPurchase) {
                startActivity(new Intent(PurchaseListActivity.this, PurchaseViewActivity.class)
