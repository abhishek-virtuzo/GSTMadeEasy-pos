...
public class SendProductCategory {

    private String TabCode;
    private SendProductCategory.CallBack listener;
    public String errorCode = "SPC";
    ...
    public SendProductCategory(String businessID, SendProductCategory.CallBack listener) {
        this.TabCode = TabCode;
        this.businessID = businessID;
        this.listener = listener;
        this.jsonString = createJSONObject();
        new SendProductCategory.apitask().execute();
    }
    ...
    private String createJSONObject() {
        try {
            ...
            ArrayList<ProductCategory> productCategoryArrayList = DatabaseHandler.getInstance().getUnsyncedProductCategories();
            ...
            for(ProductCategory productCategory : productCategoryArrayList) {
                Gson gson = new Gson();
                String jsonString = gson.toJson(productCategory);
                JSONObject jsonObject = new JSONObject(jsonString);
                jsonArray.put(jsonObject);
            }
            Log.i("ProductCategory", jsonArray.toString());
            exportJson.put("ProductCategory", jsonArray);
    ...
    public class apitask extends AsyncTask<Object, Object, String> {
        ...
        protected void onPostExecute(String message) {
            ...
            listener.afterSendProductCategory();
        }
    ...
    public JSONObject sendDataToServer(String url, String jsonString){
        ...
        try {
            ...
            url = Uri.parse(URL.GSTSendProductCategoryURL).buildUpon()
                    .appendQueryParameter("BusinessID", businessID)
                    .appendQueryParameter("ProductCategory", jsonString).toString();

            urlHit = Uri.parse(URL.GSTSendProductCategoryURL).buildUpon()
