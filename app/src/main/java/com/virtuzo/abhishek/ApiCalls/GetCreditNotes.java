...
public class GetCreditNotes {
    ...
    public ArrayList<CreditDebitNote> creditNoteArrayList;
    private GetCreditNotes.CallBack listener;
    String businessID, OutletId, RoleID, OutletTypeID;
    public String resultMessage = "";
    public String errorCode = "G CN";
    public String apiResponse = "";

    public GetCreditNotes(String businessID, String OutletId, String RoleID, String OutletTypeID, GetCreditNotes.CallBack listener){
        this.businessID = businessID;
        this.OutletId = OutletId;
        this.RoleID = RoleID;
        this.OutletTypeID = OutletTypeID;
        this.listener = listener;
        new GetCreditNotes.apitask().execute();
    }

    public interface CallBack {
        void afterGetCreditNotes();
    }
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            if(RoleID.equals("6") && OutletTypeID.equals("1")) {
                url = Uri.parse(URL.GSTGetCreditNotesURL).buildUpon()
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    JSONArray jsonArray = dataJsonObject.getJSONArray("CreditNote");
                    for (int i = 0; i < jsonArray.length(); i++) {
                        CreditDebitNote creditNote;
                        Gson gson = new Gson();
                        String jsonString = jsonArray.getJSONObject(i).toString();
                        creditNote = gson.fromJson(jsonString, CreditDebitNote.class);
...
//                        masterSalesReturn.setSalesReturnDate(MyFunctions.convertServerReceievedDateToDateFormat(masterSalesReturn.getSalesReturnDate()));
                        creditNote.setSynced(DatabaseHandler.CREDITNOTE_SYNCED_CODE_Synced);
