...
public class GetDeliveryOrders {

    public ArrayList<MasterDeliveryOrder> masterDeliveryOrderArrayList;
    public ArrayList<TransactionDeliveryOrder> transactionDeliveryOrderArrayList;
    private GetDeliveryOrders.CallBack listener;
    String businessID, OutletId, RoleID, OutletTypeID;
    public String resultMessage = "";
    public String errorCode = "G DO";
    public String apiResponse = "";

    public GetDeliveryOrders(String businessID, String OutletId, String RoleID, String OutletTypeID, GetDeliveryOrders.CallBack listener){
        this.businessID = businessID;
        this.OutletId = OutletId;
        this.RoleID = RoleID;
        this.OutletTypeID = OutletTypeID;
        this.listener = listener;
        new GetDeliveryOrders.apitask().execute();
    }

    public interface CallBack {
        void afterGetDeliveryOrders();
    }
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            masterDeliveryOrderArrayList = new ArrayList<>();
            transactionDeliveryOrderArrayList = new ArrayList<>();

            if(RoleID.equals("6") && OutletTypeID.equals("1")) {
                url = Uri.parse(URL.GSTGetDeliveryOrdersURL).buildUpon()
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    JSONArray jsonArray = dataJsonObject.getJSONArray("DeliveryOrder");
                    for (int i = 0; i < jsonArray.length(); i++) {
                        MasterDeliveryOrder masterDeliveryOrder;
                        Gson gson = new Gson();
                        String jsonString = jsonArray.getJSONObject(i).toString();
                        masterDeliveryOrder = gson.fromJson(jsonString, MasterDeliveryOrder.class);

                        // DeliveryOrder date
//                        masterDeliveryOrder.setDeliveryOrderDate(MyFunctions.convertServerReceievedDateToDateFormat(masterDeliveryOrder.getDeliveryOrderDate()));
                        masterDeliveryOrder.setSynced(DatabaseHandler.M_DELIVERYORDER_SYNCED_CODE_Synced);
                        masterDeliveryOrderArrayList.add(masterDeliveryOrder);
                    }
                    jsonArray = dataJsonObject.getJSONArray("TransactionDeliveryOrder");
                    for (int i = 0; i < jsonArray.length(); i++) {
                        TransactionDeliveryOrder transactionDeliveryOrder;
                        Gson gson = new Gson();
                        String jsonString = jsonArray.getJSONObject(i).toString();
                        transactionDeliveryOrder = gson.fromJson(jsonString, TransactionDeliveryOrder.class);
        ...
        protected void onPostExecute(Void result) {
            ...
            listener.afterGetDeliveryOrders();
        }
