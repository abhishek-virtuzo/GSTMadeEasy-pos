...
public class GetPaymentMode {
    ...
    public ArrayList<PaymentMode> paymentModeList;
    private CallBack listener;
    int businessID;
    public String errorCode = "G PMM";
    public String apiResponse = "";
    public String resultMessage = "";

    public GetPaymentMode(int businessID, CallBack listener) {//, CallbackAfterListsRecieved callback){
...
//        }
        ...
        protected void onPreExecute() {
            ...
            url = Uri.parse(URL.GSTGetPaymentModeURL).buildUpon().appendQueryParameter("BusinessId", ""+businessID).toString();
            Log.d("check", "API : " + url);
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                       ...
                       PaymentMode paymentMode;
                        ...
                        paymentMode = gson.fromJson(jsonString, PaymentMode.class);
