...
public class GetSuppliers {
    ...
    private GetSuppliers.CallBack listener;
    int businessID;
    public String errorCode = "GSP";
    public String resultMessage = "";
    public String apiResponse = "";

    public GetSuppliers(int businessID, GetSuppliers.CallBack listener){//}, DatabaseHandler dbHandler) {
...
//        productList = new ArrayList<>(this.dbHandler.getProductList());
        ...
        new GetSuppliers.apitask().execute();

    }

    public interface CallBack {
        void afterGetSuppliers();
    }
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = Uri.parse(URL.GSTGetSuppliersURL).buildUpon().appendQueryParameter("BusinessId", ""+businessID).toString();
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        supplier = gson.fromJson(jsonString, Supplier.class);
                        supplier.setSynced(DatabaseHandler.SUPPLIER_SYNCED_CODE_Synced);
