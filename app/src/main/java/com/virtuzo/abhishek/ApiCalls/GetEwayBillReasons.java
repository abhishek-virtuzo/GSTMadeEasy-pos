...
public class GetEwayBillReasons {

    public ArrayList<EwayBillReason> ewayBillReasonArrayList;
    private CallBack listener;
    String businessID;
    public String errorCode = "G EWBR";
    public String apiResponse = "";
    public String resultMessage = "";

    public GetEwayBillReasons(String businessID, CallBack listener) {//, CallbackAfterListsRecieved callback){
...
//        }
        ...
        protected void onPreExecute() {
            ...
            ewayBillReasonArrayList = new ArrayList<>();

            url =Uri.parse(URL.GSTGetEWayBillReasonsURL).buildUpon().appendQueryParameter("BusinessId", ""+businessID).toString();
            Log.d("check", "API : " + url);
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        EwayBillReason billReason;
                        Gson gson = new Gson();

                        String jsonString = jsonarray.getJSONObject(i).toString();

                        billReason = gson.fromJson(jsonString, EwayBillReason.class);

                        ewayBillReasonArrayList.add(billReason);
        ...
        protected void onPostExecute(Void result) {
            ...
            listener.afterGetEwayBillReasons();
        }
