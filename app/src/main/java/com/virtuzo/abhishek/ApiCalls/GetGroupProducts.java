...
public class GetGroupProducts {

    public ArrayList<GroupProductItem> groupProductItems;
    private GetGroupProducts.CallBack listener;
    public String resultMessage = "";
    public String errorCode = "G GPD";
    public String apiResponse = "";
    String businessID;

    public GetGroupProducts(String businessID, GetGroupProducts.CallBack listener) {//, CallbackAfterListsRecieved callback){

        this.businessID = businessID;
        this.listener = listener;

        new GetGroupProducts.apitask().execute();

    }

    public interface CallBack {
        void afterGetGroupProducts();
    }
...
//        }
        ...
        protected void onPreExecute() {
            ...
            groupProductItems = new ArrayList<>();
            url = Uri.parse(URL.GSTGetGroupProductsURL).buildUpon().appendQueryParameter("BusinessId", businessID).toString();
            Log.d("check", "API : " + url);
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    JSONArray jsonarray = jsonObject.getJSONArray("GroupProducts");
                    for (int i = 0; i < jsonarray.length(); i++) {
                        GroupProductItem groupProductItem;
                        Gson gson = new Gson();
                        String jsonString = jsonarray.getJSONObject(i).toString();
                        groupProductItem = gson.fromJson(jsonString, GroupProductItem.class);
                        groupProductItem.setSynced(1);
        ...
        protected void onPostExecute(Void result) {
            ...
            listener.afterGetGroupProducts();
        }
