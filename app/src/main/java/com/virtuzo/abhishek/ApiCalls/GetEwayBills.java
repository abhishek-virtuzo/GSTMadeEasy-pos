...
public class GetEwayBills {

    public ArrayList<EwayBill> ewayBillArrayList;
    private CallBack listener;
    String businessID;
    public String resultMessage = "";
    public String errorCode = "G EWB";
    public String apiResponse = "";

    public GetEwayBills(String businessID, CallBack listener) {//, CallbackAfterListsRecieved callback){
...
//        }
        ...
        protected void onPreExecute() {
            ...
            ewayBillArrayList = new ArrayList<>();

            url =Uri.parse(URL.GSTGetEWayBillsURL).buildUpon()
                    .appendQueryParameter("BusinessId", ""+businessID)
                    .appendQueryParameter("SalesID", "0")
                    .appendQueryParameter("InvoiceNumber", "").toString();
            Log.d("check", "API : " + url);
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        bill = gson.fromJson(jsonString, EwayBill.class);
                        bill.setSynced(1);
                        ewayBillArrayList.add(bill);
