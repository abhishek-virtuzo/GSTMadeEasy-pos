...
public class GetHSCCodes {

    private GetHSCCodes.CallBack listener;
    String businessID;
    public String resultMessage = "";
    public String errorCode = "Get HSN";
    public String apiResponse = "";

    public GetHSCCodes(String businessID, GetHSCCodes.CallBack listener){//}, DatabaseHandler dbHandler) {
...
//        productList = new ArrayList<>(this.dbHandler.getProductList());
        ...
        new GetHSCCodes.apitask().execute();

    }

    public interface CallBack {
        void afterGetHSCCodes();
    }
    ...
    public class apitask extends AsyncTask<Object, Object, Void> {
        ...
        protected void onPreExecute() {
            ...
            url = Uri.parse(URL.GSTGetHSNCodesURL).buildUpon()
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                e.printStackTrace();
                MyFunctions.errorOccuredInApiCall(url + "\n" + resultJson, jsonObject.toString());
            }
