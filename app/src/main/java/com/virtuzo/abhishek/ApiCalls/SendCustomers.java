...
public class SendCustomers {
    ...
    private SendCustomers.CallBack listener;
    public String errorCode = "SCT";
    ...
    public SendCustomers(String businessID, String TabCode, SendCustomers.CallBack listener) {
        this.TabCode = TabCode;
        this.businessID = businessID;
        this.listener = listener;
        this.jsonString = isApiCall();
        new SendCustomers.apitask().execute();
    }

    private String isApiCall() {
        customerArrayList = DatabaseHandler.getInstance().getUnsyncedCustomersListFromDB();
    ...
    private String createOneJSONObject(Customer customer) {
        try {
            ...
            Log.i("Customer List", jsonArray.toString());
            exportJson.put("CustomerList", jsonArray);
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                for (Customer customer : customerArrayList) {
                    jsonString = createOneJSONObject(customer);
                    ...
                    if(message.equals(MyFunctions.SUCCESS_MESSAGE)) {
                        DatabaseHandler.getInstance().singleCustomerSyncSuccessful(customer.getCustomerId());
                    } else {
                        break;
                    }
                }
    ...
    public JSONObject sendDataToServer(String url, String jsonString){
        ...
        try {
            ...
            url = Uri.parse(URL.GSTSendCustomersURL).buildUpon()
                    .appendQueryParameter("BusinessID", businessID)
                    .appendQueryParameter("Customers", jsonString).toString();

            urlHit = Uri.parse(URL.GSTSendCustomersURL).buildUpon()
