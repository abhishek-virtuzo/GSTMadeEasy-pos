...
public class GetGSTCategory {


    public ArrayList<GSTCategory> gstCategoryList;
    private CallBack listener;
    int businessID;
    public String errorCode = "G GSTC";
    public String apiResponse = "";
    public String resultMessage = "";

    public GetGSTCategory(int businessID, CallBack listener) {//, CallbackAfterListsRecieved callback){
...
//        }
        ...
        protected void onPreExecute() {
            ...
            gstCategoryList = new ArrayList<>();

            url =Uri.parse(URL.GetGSTCategoryURL).buildUpon().appendQueryParameter("BusinessId", ""+businessID).toString();
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        gstCategory = gson.fromJson(jsonString, GSTCategory.class);

                        gstCategoryList.add(gstCategory);
